...
void print_attr(attr_t *attr, int64_t nesting_level) {
    switch (attr->type) {
        case INT: {
...
void print_value(ast_node *node, int64_t nesting_level) {
    switch (node->type) {
        case FILENAME_N: {
...
void print_node(ast_node *node, int64_t nesting_level) {
    if (node) {
